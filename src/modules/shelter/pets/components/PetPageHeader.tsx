...
import { FiPlus, FiBell, FiSearch, FiFilter, FiChevronDown } from 'react-icons/fi';
...
export const PetPageHeader: React.FC<PetPageHeaderProps> = ({
    ...
    return (
        <div className="flex items-center gap-3 mb-6 flex-nowrap overflow-x-auto">
            {/* Title */}
            <h2 className="font-sans text-[32px] leading-none text-[#0D062D] font-bold shrink-0 whitespace-nowrap">
                {title}
            </h2>
            ...
            <button
                ...
                className="shrink-0 w-7 h-7 flex items-center justify-center text-[#E89B5A] hover:text-[#D68B4E] transition-colors"
            >
                <FiBell size={20} />
            </button>
