...
import { X, Phone, Mail, Download, ChevronUp, ChevronDown, Send, Check, MoreHorizontal, Mars, Venus } from 'lucide-react';
          ...
          <div className="flex gap-5 mb-8 mt-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              <button className="flex items-center gap-2 text-gray-600 hover:text-[#E89B5A] transition-colors text-[13px]">
                <Download size={14} />
                <u>Tải đơn <span className="font-semibold">{application.fullName?.split(' ')[0] || 'Julia'} - Application.pdf</span></u>
              </button>
