...
export const InterviewScheduleModal: React.FC<InterviewScheduleModalProps> = ({
  ...
  const handleSubmit = () => {
    // Thu thập dữ liệu form ở đây để gửi lên API nếu cần
    onSubmit({});
  };
    ...
    <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <div className="px-7 pt-6 pb-4 border-b border-gray-100 relative shrink-0">
          ...
          <h2 className="text-[22px] font-bold text-gray-900 leading-tight mb-2">Đặt lịch hẹn phỏng vấn</h2>
          <div className="flex items-center gap-3">
            ...
            <button className="bg-[#5982E6] hover:bg-[#4a72d4] transition-colors text-white text-[12px] font-medium px-4 py-1.5 rounded-md">
              Bấm vào đây để giao quyền đặt lịch
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-7 py-6">
            ...
            <div className="border border-gray-200 rounded-[16px] p-5 shadow-sm bg-white">
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-[15px] text-gray-900">{application.fullName}</span>
                ...
                <div className="flex items-center gap-3 flex-1 justify-end">
                  ...
                  <img 
                    src={application.pet?.avatarUrl || "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=100"} 
                    className="w-12 h-12 rounded-full object-cover border border-gray-100" 
              ...
              <div className="grid grid-cols-2 gap-x-5 gap-y-5">
                ...
                <div className="col-span-1">
                  ...
                  <input 
                    type="text" 
                    defaultValue={`Hẹn phỏng vấn nhận nuôi ${application.pet?.name || 'Luna'}`}
                ...
                <div className="col-span-1">
                  ...
                  <textarea 
                    rows={2}
                    defaultValue="Sân nhà nhiều chó&#10;123 street, city, state"
          ...
          {/* Section 2: Phân công thành viên */}
          <div>
            <h3 className="font-bold text-[14px] text-gray-900 mb-1">Phân công thành viên</h3>
            <p className="text-[12px] text-gray-500 mb-3">Chọn một thành viên phù hợp để phụ trách hoặc tham gia buổi phỏng vấn</p>
            ...
            <div className="border border-gray-200 rounded-[16px] p-5 shadow-sm bg-white">
              {members.map((member, index) => (
                <div key={index} className="grid grid-cols-2 gap-x-5 mb-4">
                  ...
                  <div className="col-span-1">
                    <label className="text-[12px] font-medium text-gray-500 mb-1.5 block">Nội dung cần lưu ý</label>
                    <input 
                      type="text" 
