  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
          ...
          <div className="flex gap-5 mb-6 mt-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              <button className="flex items-center gap-2 text-gray-600 hover:text-[#E89B5A] transition-colors text-[13px]">
                <Download size={14} />
                <u>Download <span className="font-semibold">{application.fullName.split(' ')[0]} - Application.pdf</span></u>
              </button>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              <h3 className="font-bold text-[14px] text-gray-900">Tags</h3>
                  ...
                  <div className="border border-gray-200 rounded-[16px] p-5 shadow-sm bg-white">
                    ...
                    <div className="flex items-center justify-between mb-5">
                      <div className="flex items-center gap-3 flex-1">
                        <img src="https://images.unsplash.com/photo-1543466835-00a7907e9de1?q=80&w=100" className="w-10 h-10 rounded-full object-cover border border-gray-100" alt="Applicant" />
                        <div className="flex flex-col">
                          <span className="font-bold text-[13px] text-gray-900">{application.fullName}</span>
                      ...
                      <div className="flex items-center gap-3 flex-1 justify-end">
                        ...
                        <img src={application.pet?.avatarUrl || "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=100"} className="w-10 h-10 rounded-full object-cover border border-gray-100" alt="Pet" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="text" defaultValue={`Hẹn phỏng vấn nhận nuôi ${application.pet?.name || 'Luna'}`} className="w-full border border-gray-200 rounded-[8px] px-3 py-2 text-[12px] text-gray-900 outline-none" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input type="text" defaultValue="https://shelter.pawlife.vn/shelter/pets" className="w-full border border-gray-200 rounded-[8px] px-3 py-2 text-[12px] text-gray-900 outline-none" />
                      </div>
                      <div>
                        <label className="text-[11px] font-medium text-gray-500 mb-1.5 block">Ngày & giờ hẹn</label>
                        <div className="relative">
                          <input type="text" placeholder="Pick a slot" className="w-full border border-gray-200 rounded-[8px] pl-3 pr-8 py-2 text-[12px] text-gray-900 outline-none" />
                  ...
                  <div className="border border-gray-200 rounded-[16px] p-5 shadow-sm bg-white">
                    <div className="grid grid-cols-2 gap-4 mb-3">
                      <div>
                        ...
                        <input type="text" placeholder="Tên" className="w-full border border-gray-200 rounded-[8px] px-3 py-2 text-[12px] text-gray-900 outline-none" />
                      </div>
                      <div>
                        <label className="text-[11px] font-medium text-gray-500 mb-1.5 block">Nội dung cần lưu ý</label>
                        <input type="text" placeholder="Optional" className="w-full border border-gray-200 rounded-[8px] px-3 py-2 text-[12px] text-gray-900 outline-none" />
                      </div>
                    </div>
        ...
        {/* Bottom Fixed Action Button (Giữ nguyên như trong mockup của bạn) */}
