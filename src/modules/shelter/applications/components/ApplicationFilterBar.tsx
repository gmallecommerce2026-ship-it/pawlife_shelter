    ...
    <div className="flex items-center gap-3">
      ...
      <form onSubmit={handleSubmit} className="relative flex items-center">
        ...
        <input
          ...
          className="w-[260px] h-[38px] bg-white border border-[#858585] rounded-full pl-9 pr-4 text-[13px] text-gray-800 focus:outline-none focus:border-[#C4C4C4] placeholder-gray-400 transition-colors font-['Be Vietnam Pro',_sans-serif]"
        />
      </form>

      {/* Nút Filter */}
      <button className="flex items-center gap-2 h-[38px] px-4 bg-white border border-[#858585] rounded-full hover:bg-gray-50 transition-colors">
        <Filter size={14} className="text-gray-400" strokeWidth={2} />
        <span className="text-[13.5px] text-gray-500 font-medium font-['Be Vietnam Pro',_sans-serif]">Bộ lọc</span>
      ...
      <button className="flex items-center gap-2 h-[38px] px-4 bg-white border border-[#858585] rounded-full hover:bg-gray-50 transition-colors">
        ...
        <span className="text-[13.5px] text-gray-500 font-medium font-['Be Vietnam Pro',_sans-serif]">Hôm nay</span>
        <ChevronDown size={14} className="text-gray-400 ml-2" strokeWidth={2} />
      </button>
    </div>
  );
